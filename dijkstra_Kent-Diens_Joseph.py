...
def main():
    ...
    OBSTACLES = {'first_left_rectangle': (BLOATED_FIRST_RECTANGLE_LEFT_VERTICAL_EDGE,
    ...
    OBSTACLES['second_left_rectangle'] = (BLOATED_SECOND_RECTANGLE_LEFT_VERTICAL_EDGE,
    ...
    OBSTACLES['hexagon'] = (EDGE_AB, EDGE_BC, EDGE_ED, EDGE_FE, EDGE_AF, EDGE_CD)
    ...
    TOP_LEFT_BLOATED_WALL_X, TOP_LEFT_BLOATED_WALL_Y = 0, 0
    TOP_LEFT_BLOATED_WALL_WIDTH = BLOATED_FIRST_LEFT_RECTANGLE_X
    TOP_LEFT_BLOATED_WALL_HEIGHT = CLEARANCE
    TOP_BLOATED_WALL_X, TOP_BLOATED_WALL_Y = FIRST_LEFT_RECTANGLE_X+FIRST_LEFT_RECTANGLE_WIDTH+CLEARANCE,0
    TOP_BLOATED_WALL_WIDTH = WINDOW_WIDTH-TOP_BLOATED_WALL_X
    TOP_BLOATED_WALL_HEIGHT = CLEARANCE
